...
export default async function SignIn() {
  ...
  return (
    <div className='h-screen justify-end bg-green500 md:flex'>
      <div className='flex h-[40%] w-full rounded-b-[20px] bg-green300 md:hidden md:h-full md:w-[40%] md:rounded-l-[20px]'>
      ...
      <div className='flex h-[60%] w-full items-center justify-center md:h-full md:w-[60%]'>
        <form className='flex w-[384px] flex-col justify-start gap-5'>
          ...
          <Button
            formAction={signIn}
            className='h-[44px] w-[384px] bg-success text-white'
          >
            Sign in
          </Button>
        </form>
